            ...
            if (f.hotData) {
                ...
                var a = f.hotTemplate.container.replaceWith({
                    text: [f.hotTemplate.title.replaceWith({
                        text: $$.module.address.source[o.source + "_keyWord"] || " \u53EF\u8F93\u5165\u57CE\u5E02\u62FC\u97F3"
