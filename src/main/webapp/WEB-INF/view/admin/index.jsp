    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-alerts">
                                <li>
                                    <a href="mailbox.html">
                                        <div>
                                            <i class="fa fa-lock"></i> 您有16条未读消息
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="main" frameborder="0" data-id="admin/main.jsp" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
